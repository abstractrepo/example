...
export default defineTemplateConfig({
  ...
  structures: [
    ...
    { from: "./tsconfig.json.stub", to: "<types>/tsconfig.json" },
    { from: "./tsconfig.node.json.stub", to: "<types>/tsconfig.node.json" },
    { from: "./vite.config.ts.stub", to: "<types>/vite.config.ts" },
  ],
  tags: root.getTagsList(["vite", "react", "ts", "tsx"]),
